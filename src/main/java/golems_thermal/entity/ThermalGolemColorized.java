...
public abstract class ThermalGolemColorized extends GolemColorized {
	...
	private static final ResourceLocation TEXTURE_BASE = makeTexture(ThermalGolems.MODID, "golem_metal");
	private static final ResourceLocation TEXTURE_OVERLAY_LOW = makeTexture(ThermalGolems.MODID, "golem_metal_grayscale_low");
	private static final ResourceLocation TEXTURE_OVERLAY_HIGH = makeTexture(ThermalGolems.MODID, "golem_metal_grayscale_high");
